...
def update_county_attributes(abstract):
    ...
    abstract.county.buttons = {
        ...
        "Login Prompt": jaguar.login_prompt_class_name,
        "Login": jaguar.login_button_id,
        # SEARCH
        "Clear Search": jaguar.clear_search_button_id,
    ...
    abstract.county.inputs = {  # Consider changing to 'search_inputs'
        ...
        "Start Date": jaguar.start_date_input_id,
        "End Date": jaguar.end_date_input_id
    }
