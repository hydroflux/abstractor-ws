def add_no_record_format(project):
    no_record_format = project.conditional_formats['no_record_format']
    no_record_format['format'] = project.text_formats['no_record']
    project.worksheet.conditional_format(project.worksheet_range, no_record_format)


def add_multiple_document_format(project):
    multi_documents_format = project.conditional_formats['multi_documents_format']
    multi_documents_format['format'] = project.text_formats['multiple_documents']
...
def add_no_document_image_format(project):
    no_document_image_format = project.conditional_formats['no_image_format']
    no_document_image_format['format'] = project.text_formats['no_image']
...
def add_out_of_county_format(project):
    font_format = project.text_formats['out_of_county']
    out_of_county_format = project.conditional_formats['out_of_county_format']
